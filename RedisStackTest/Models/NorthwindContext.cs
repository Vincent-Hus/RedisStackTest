    ...
    public partial class NorthwindContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ApplicationUser>(entity =>
            {
                ...
                entity.HasIndex(e => e.UserId, "IX_ApplicationUser")
                    .IsUnique();
            ...
            modelBuilder.Entity<Art>(entity =>
            {
                ...
                entity.Property(e => e.VisibleStatus).HasDefaultValueSql("((1))");
            });

            modelBuilder.Entity<ArtLike>(entity =>
            {
                entity.ToTable("ArtLike");

                entity.Property(e => e.ArtLikeId).HasColumnName("ArtLikeID");
